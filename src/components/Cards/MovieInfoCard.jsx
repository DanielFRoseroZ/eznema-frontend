...
export default function MovieInfoCard({ movie, initial }) {
    ...
    const url = `/movie/${movie.title}?id=${movie.id}`;

    return (
        <Link href={url}>
            <motion.div 
                className="shadow-lg shadow-gray-400 rounded-3xl md:rounded-t-3xl flex md:flex-col md:w-[250px] 2xl:w-[350px] h-full 2xl:hover:cursor-pointer"
                initial={{scale:1}}
